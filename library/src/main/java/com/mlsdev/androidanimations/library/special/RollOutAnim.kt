...
class RollOutAnim(view: View, animationParams: AnimationParams = AnimationParams()) : BaseViewAnim(view, animationParams) {
    override fun prepare(target: View, animatorSet: AnimatorSet) {
        ...
        animatorSet.playTogether(
            ...
            ObjectAnimator.ofFloat(target, "rotation", 0.0f, 120.0f)
        )
    }
}