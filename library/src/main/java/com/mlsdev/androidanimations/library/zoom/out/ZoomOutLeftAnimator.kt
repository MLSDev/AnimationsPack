...
class ZoomOutLeftAnimator(view: View, animationParams: AnimationParams = AnimationParams()) : BaseViewAnimator(view, animationParams) {
    override fun prepare(target: View, animatorSet: AnimatorSet) {
        animatorSet.playTogether(
            ...
            ObjectAnimator.ofFloat(target, "translationX", 0.0f, 42.0f, -target.right.toFloat())
        )
    }
}